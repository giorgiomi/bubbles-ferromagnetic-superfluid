...
\end{equation*}
yielding the shoulder center $c$. Eventually, we obtain the bubble center $x_0 = (c_1 + c_2)/2$ and the bubble width $w = c_2 - c_1$.
...
\end{equation*}
with $x_0 = c$ being the bubble center and $w = \num{2.335}\ \sigma$ its width.
