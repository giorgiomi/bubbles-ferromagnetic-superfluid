...
\begin{equation*}
    \mathcal{A}_{\rm fit}(x) = (1-\Delta)\exp[-\frac{x}{l_1}] + \Delta\, .
\end{equation*}

\paragraph{Inside}
An example of fit on the inside shots is presented in Fig.\ \ref{fig:fit_time_inside}, where the shots are grouped by time. The parameters retrieved from the fit are in Fig.\ \ref{fig:param_time_inside}, \ref{fig:param_size_inside} and \ref{fig:param_slope_inside}.
\begin{figure}[h!]
    \centering
...
\begin{figure}[h!]
    ...
    \caption{Fit parameters $\ell_1$, $\Delta$ and $\ell_2$ of shots grouped by time.}
    \label{fig:param_time_inside}
\end{figure}
\begin{figure}[h!]
    \centering
    \includegraphics[width = \textwidth]{figures/chap2/param_size_inside.png}
    \caption{Fit parameters $\ell_1$, $\Delta$ and $\ell_2$ of shots grouped by size.}
    \label{fig:param_size_inside}
\end{figure}
\begin{figure}[h!]
    \centering
    \includegraphics[width = \textwidth]{figures/chap2/param_slope_inside.png}
    \caption{Fit parameters $\ell_1$, $\Delta$ and $\ell_2$ of shots grouped by slope.}
