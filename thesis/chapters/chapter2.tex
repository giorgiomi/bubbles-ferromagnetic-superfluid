...
\begin{figure}[t!]
    ...
    \caption{Example of FFT and ACF calculated in a sequence. The values for each shot are shown in the left plots with colormaps, while the averages are on the right. FFT magnitudes are plotted in log scale.}
    \label{fig:inside_00}
\end{figure}
