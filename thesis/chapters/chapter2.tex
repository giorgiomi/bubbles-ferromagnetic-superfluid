...
\begin{equation*}
    \mathcal{A}_{\rm fit}(x) = (1 - \Delta)\cos(\frac{x}{l_2})\exp[-\left(\frac{x}{l_1}\right)^\alpha] + \Delta\, ,
\end{equation*}
...
\begin{figure}
    \centering
    \includegraphics[width = 0.75\textwidth]{figures/chap2/param_time_inside.png}
    \caption{Fit parameters $l_1$ and $\Delta$ (off) of shots grouped by time.}
