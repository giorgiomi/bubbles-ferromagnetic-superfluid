...
Z_dict = {omega_val: Z[(omega == omega_val)][np.argsort(size[(omega == omega_val)])] for omega_val in [300, 400, 600, 800]}
Z_300, Z_400, Z_600, Z_800 = Z_dict[300], Z_dict[400], Z_dict[600], Z_dict[800]
...
# Plot FFT results
plt.plot(CFG, fft_300, label='300 Hz')
plt.plot(CFG, fft_400, label='400 Hz')
plt.plot(CFG, fft_600, label='600 Hz')
plt.plot(CFG, fft_800, label='800 Hz')
plt.xlabel('Frequency')
plt.ylabel('FFT Magnitude')
plt.legend()
plt.title('FFT Magnitudes for Different Frequencies')
plt.show()

# Plot ACF results
plt.plot(CLG, acf_300, label='300 Hz')
plt.plot(CLG, acf_400, label='400 Hz')
plt.plot(CLG, acf_600, label='600 Hz')
plt.plot(CLG, acf_800, label='800 Hz')
plt.xlabel('Lag')
plt.ylabel('ACF Value')
plt.legend()
plt.title('ACF Values for Different Frequencies')
plt.show()
