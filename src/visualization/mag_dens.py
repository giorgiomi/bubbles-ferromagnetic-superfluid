...
for day in chosen_days:
    for seq in sel_seq[day]:
        ...
        df_M = pd.read_csv(f"data/selected/day_{day}/seq_{seq}/Z_sorted.csv")
        df_D = pd.read_csv(f"data/selected/day_{day}/seq_{seq}/density.csv")
        df_in_l = pd.read_csv(f"data/selected/day_{day}/seq_{seq}/in_left.csv")
        df_in_r = pd.read_csv(f"data/selected/day_{day}/seq_{seq}/in_right.csv")
        df_out_l = pd.read_csv(f"data/selected/day_{day}/seq_{seq}/out_left.csv")
        df_out_r = pd.read_csv(f"data/selected/day_{day}/seq_{seq}/out_right.csv")
