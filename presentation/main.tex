...
\begin{frame}{\textbf{Theoretical background}: Ferromagnetism}
  \begin{figure}
      \centering
      \includegraphics[width=0.7\textwidth]{../thesis/figures/chap1/ferro.png}
  \end{figure}
\end{frame}
...
\begin{frame}{\textbf{Theoretical background}: False Vacuum Decay}
  \begin{figure}
      \centering
      \includegraphics[width=0.7\textwidth]{../thesis/figures/chap1/FVD.png}
  \end{figure}    
\end{frame}
...
\begin{frame}{\textbf{Data analysis}: Bubble shots and fits}
  ...
  \begin{figure}
      \centering
      \includegraphics[width=0.7\textwidth]{../thesis/figures/chap2/arctan_fit.png}
  \end{figure}
\end{frame}
...
\begin{frame}{\textbf{Data analysis}: Parameters clustering}
  ...
  \begin{figure}
      \centering
      \includegraphics[width=0.7\textwidth]{../thesis/figures/chap2/b_param_cluster.png}
  \end{figure}
\end{frame}
